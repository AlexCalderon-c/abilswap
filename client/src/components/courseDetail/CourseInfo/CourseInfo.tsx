    ...
    <div>
      ...
      <div className='flex flex-wrap items-center gap-6'>
        <div className='flex items-center gap-2'>
          ...
          <div>
            <p className='text-sm font-medium text-text-primary'>{course.teacher_name || 'Instructor'}</p>
        ...
        <div className='flex items-center gap-1.5'>
          ...
          <span className='text-sm font-semibold text-text-primary'>{course.rating_avg?.toFixed(1)}</span>
